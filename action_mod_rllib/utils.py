...
def _get_ppo_data():
    ...
    setup_tf_before_init_mixins = ppo_tf_policy.setup_config
    ...
    setup_torch_before_init_mixins = ppo_tf_policy.setup_config
    ...
    return policy_tf_cls, setup_tf_before_init_mixins, tf_mixins, \
